...
const Education = () => {
  ...
  const EDUCATIONS = [
    {
      ...
      minorType: "Minor in ",
      minorName: "Computational Mathematics",
      gpa: "4.0", 
    ...
    },
    {
      ...
      minorType: "Minor in ",
      minorName: "Financial Mathematics",
      gpa: "4.0", 
  ...
  return (
    <div id="education" className="border-b border-neutral-900 pb-4 mx-6 pt-2">
      <motion.h2
        ...
        {EDUCATIONS.map((education, index) => (
          <div key={index} className="flex flex-col lg:flex-row mb-8">
            ...
            >
              ...
              <p className="mb-2 text-m text-neutral-300">{education.minorType}<span className="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 bg-clip-text  tracking-tight text-transparent">{education.minorName}</span></p> {/* Increased text size */}
