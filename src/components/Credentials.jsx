    ...
    <div className="border-b border-neutral-900 pb-4">
      ...
      ><div className="w-1/3">
          <img
            src={hoverAZ}
            alt="School Logo"
            className={`h-20 mx-auto transform transition duration-300 ease-in-out ${hoverAZ === AZ900 ? 'scale-150' : ''}`}
          ...
          >
            <h6 className="mb-2 text-xl font-semibold">Azure Fundemnetals: AZ-900</h6>
      ...
      >
          ...
          <motion.div
            ...
            className="flex-grow ml-4"
          >
            <h6 className="mb-2 text-xl font-semibold">Azure AI Fundementals: AI-900</h6>
        ...
        <div className="flex mb-8 w-full max-w-xl">
          <div className="w-1/3">
            <img src={Bloomberg} alt="School Logo" className="h-20 mx-auto" />
          </div>
          <motion.div
            whileInView={{ opacity: 1, x: 0 }}
            initial={{ opacity: 0, x: -100 }}
